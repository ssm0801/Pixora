...
const COMPARE: { label: string; values: CellValue[] }[] = [
  ...
  { label: 'Person tagging',      values: [false, false, true, true, true] },
  { label: 'Smart culling',       values: [false, false, true, true, true] },
  { label: 'Best shot picker',    values: [false, false, true, true, true] },
  { label: 'Smart search',        values: [false, false, true, true, true] },
  { label: 'Duplicate detection', values: [false, false, true, true, true] },
